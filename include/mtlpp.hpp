...
namespace mtlpp
{
    ...
    public:
        ...
        struct BlitCommandEncoder BlitCommandEncoder();
        struct RenderCommandEncoder RenderCommandEncoder(const RenderPassDescriptor& renderPassDescriptor);
        struct ComputeCommandEncoder ComputeCommandEncoder();
        struct ParallelRenderCommandEncoder ParallelRenderCommandEncoder(const RenderPassDescriptor& renderPassDescriptor);
    }
    MTLPP_AVAILABLE(10_11, 8_0);
}
